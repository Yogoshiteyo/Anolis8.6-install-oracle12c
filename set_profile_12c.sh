...
extract_installation_packages() {
    ...
    if [ ${#install_packages[@]} -eq 0 ]; then
        ...
        MD5 04CEF75991DB18F8190F7D4A19B26912
...
modify_response_file_content1() {
    ...
    local replace_content1="oracle.install.responseFileVersion=/oracle/install/rspfmt_dbinstall_response_schema_v12.2.0"
    ...
    local replace_content7="ORACLE_HOME=/data/app/oracle/product/12.1.0/dbhome_1"
    ...
    local replace_content15="oracle.install.db.config.starterdb.globalDBName=orcl"
    local keyword16="oracle.install.db.config.starterdb.SID"
    local replace_content16="oracle.install.db.config.starterdb.SID=orcl"
    ...
    local keyword18="oracle.install.db.OPER_GROUP"
    local replace_content18="oracle.install.db.OPER_GROUP=oper"
    local keyword19="oracle.install.db.BACKUPDBA_GROUP"
    local replace_content19="oracle.install.db.BACKUPDBA_GROUP=backupdba"
    local keyword20="oracle.install.db.DGDBA_GROUP"
    local replace_content20="oracle.install.db.DGDBA_GROUP=dgdba"
    local keyword21="oracle.install.db.KMDBA_GROUP"
    local replace_content21="oracle.install.db.KMDBA_GROUP=kmdba"
...
modify_dbca_response_file() {
    ...
    local keyword1='GDBNAME = "orcl12c.us.oracle.com"'
    local replace_content1='GDBNAME = "orcl"'
    local keyword2='SID = "orcl12c"'
